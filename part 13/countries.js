...
console.assert(10 > 2 * 10, "Message in case assertion is false")
console.assert(10 < 2 * 10, "Message in case assertion is true")
...

{
    ...
    while (i < countries.length) {
        whileCountries.push(countries[i]);
        i++
    }
